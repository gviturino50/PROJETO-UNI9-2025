  ...
  <div class="bg-white shadow-xl p-10 rounded-3xl w-full max-w-xl">
    ...
    >
      ...
      <!-- <div class="relative">
        ...
        <button
          type="button"
          onclick="toggleSenha('confirmar-senha', this)"
          class="absolute right-4 top-1/2 -translate-y-1/2"
        >
          <svg class="w-6 h-6 text-[#001f3d]" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <p class="text-center text-sm text-gray-700 leading-relaxed mt-4 px-6">
        Ao cadastrar-me, declaro que sou maior de idade e aceito os
        <a href="#" class="text-orange-500 font-semibold hover:underline">Termos de Serviço</a>
        e
        <a href="#" class="text-orange-500 font-semibold hover:underline">Política de Privacidade</a>.
      </p>
      ...
      <div class="flex justify-between mt-6 items-center">
        ...
        <button class="bg-orange-500 text-white text-lg font-semibold px-10 py-3 rounded-2xl hover:bg-orange-600 transition" type="submit">
          Continuar
        </button>
